...
import GestLoginButton from '@/components/Sidemenu/gestLoginButton';
    ...
    <div className="select-none text-sm">
      ...
      <div>
        ...
        <div className="mx-5 mt-2">
          <div className="border-b-2 border-t-2 border-dotted border-[#FCCFA5] py-2">
          ...
          <div className="border-b-2 border-dotted border-[#FCCFA5] py-2">
            <p className="font-semibold">
      ...
      {/* -----------------------------ログインの案内--------------------------------- */}
      <div className="mx-6 mt-6 rounded-2xl bg-[#FDF1DE] pb-8 pt-5 text-center shadow-md">
