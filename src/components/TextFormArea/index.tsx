    ...
    <div className={`flex ${witdh} mt-10 flex-col items-end`}>
      <div className="relative w-full min-w-[100px]">
        <textarea
          ...
          className="border-blue-gray-200 text-blue-gray-700 placeholder-shown:border-blue-gray-200 disabled:bg-blue-gray-50 peer mt-5 h-full min-h-[200px] w-full resize-none rounded-none bg-transparent pb-1.5 pt-6 text-base font-normal outline outline-0 transition-all focus:border-orange-500 focus:outline-0 disabled:resize-none"
